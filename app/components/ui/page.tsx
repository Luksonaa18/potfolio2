...
export default function MacbookScroll({
  ...
  return (
    <div
      ref={ref}
      className="flex h-[150vh] shrink-0 scale-[0.35] transform flex-col items-center justify-start py-0 [perspective:100px] sm:scale-50 md:scale-100 md:py-80"
    >
      <motion.h2
        style={{
      ...
      >
        {title || (
          <span className="font-bold text-white">You Can Make it with me.</span>
        )}
      </motion.h2>
      {/* Lid */}
      <Lid
